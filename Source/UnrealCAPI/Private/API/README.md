...
- `uec_api_world_actor.inl` owns context, world, player, actor, component, and timer access.
- `uec_api_reflection.inl` owns class metadata, reflected properties, and object references.
- `uec_api_gameplay.inl` owns collision, audio, UI, camera, presentation, and component configuration.
