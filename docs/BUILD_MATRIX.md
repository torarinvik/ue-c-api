...
query-only box, then checks collision settings, one-shot hit callback token and actor-handle delivery, automatic unsubscription, ABI 143 physics-simulation enable/readback/disable/readback, and handle drainage. The queue
