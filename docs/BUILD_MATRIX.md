...
that exercises completion, cancellation, signature rejection, and pending
request counts, so Unreal Build Tool does not need to synthesize temporary
targets before compiling the plugin and its first C consumer.
