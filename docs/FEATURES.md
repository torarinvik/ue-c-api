...
| Reflected actor function invocation | Runtime implemented / Unreal integration pending | ABI 131 mixes typed scalar, hard object/class/world, and text-backed positional arguments; rejects world handles and world-bound object handles from a different actor world and returns typed scalar outputs, owned reference handles, or caller-buffered Unreal property text |
