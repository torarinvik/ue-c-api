...
- The host Game/PIE probe now spawns a native latent-test actor, checks
  ...
  capacity preflight, short text-output sizing and retry, invalid world-kind
  handling, an explicit world context, real completion, canceled callback
  suppression, cross-world context rejection when another world is available,
