...
typedef struct uec_api {
    ...
    uec_result (UEC_CALL *set_component_physics_velocity)(uec_scene_component* component, uec_vector3 velocity, uec_bool add_to_current); uec_result (UEC_CALL *apply_component_impulse)(uec_scene_component* component, uec_vector3 impulse, uec_bool velocity_change); uec_result (UEC_CALL *apply_component_force)(uec_scene_component* component, uec_vector3 force);
} uec_api;
