...
typedef struct uec_api {
    ...
    uec_result (UEC_CALL *save_versioned_application_data)(uec_context* context, uec_string_view slot_name, int32_t user_index, uint32_t schema_version, const uint8_t* data, size_t data_size, uec_bool* out_saved); uec_result (UEC_CALL *load_versioned_application_data)(uec_context* context, uec_string_view slot_name, int32_t user_index, uint32_t* out_schema_version, uint8_t* buffer, size_t buffer_capacity, size_t* out_required_size); uec_result (UEC_CALL *get_controller_enhanced_input_subsystem)(uec_actor* controller, uec_object** out_subsystem);
} uec_api;
