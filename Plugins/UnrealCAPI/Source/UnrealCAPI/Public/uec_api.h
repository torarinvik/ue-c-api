...
enum {
    ...
    UEC_CAPABILITY_EVENT_BRIDGE = UINT64_C(1) << 28, UEC_CAPABILITY_ASYNC_LATENT_FUNCTIONS = UINT64_C(1) << 29
};
...
enum { UEC_FUNCTION_FLAG_BLUEPRINT_CALLABLE = 1u << 0, UEC_FUNCTION_FLAG_NATIVE = 1u << 1, UEC_FUNCTION_FLAG_EVENT = 1u << 2, UEC_FUNCTION_FLAG_LATENT = 1u << 3, UEC_FUNCTION_FLAG_NETWORK = 1u << 4, UEC_FUNCTION_FLAG_AUTHORITY_ONLY = 1u << 5 }; enum { UEC_PROPERTY_FLAG_EDIT_CONST = 1u << 0, UEC_PROPERTY_FLAG_BLUEPRINT_READ_ONLY = 1u << 1, UEC_PROPERTY_FLAG_CONST_PARAMETER = 1u << 2, UEC_PROPERTY_FLAG_RETURN = 1u << 3, UEC_PROPERTY_FLAG_PARAMETER = 1u << 4, UEC_PROPERTY_FLAG_OUT = 1u << 5, UEC_PROPERTY_FLAG_REFERENCE = 1u << 6 };
...
typedef enum uec_collision_response { UEC_COLLISION_RESPONSE_IGNORE = 0, UEC_COLLISION_RESPONSE_OVERLAP = 1, UEC_COLLISION_RESPONSE_BLOCK = 2 } uec_collision_response;
...
} uec_widget_visibility; typedef enum uec_checkbox_state { UEC_CHECKBOX_UNCHECKED = 0, UEC_CHECKBOX_CHECKED = 1, UEC_CHECKBOX_UNDETERMINED = 2 } uec_checkbox_state;
...
typedef void (UEC_CALL *uec_widget_event_callback)(uint64_t subscription_id, void* user_data);
...
typedef struct uec_api {
    ...
    uec_result (UEC_CALL *get_config_string)(uec_context* context,
                                             ...
                                             size_t buffer_size,
                                             size_t* required_size);
    uec_result (UEC_CALL *set_config_string)(uec_context* context, uec_string_view section, uec_string_view key, uec_string_view value);
    uec_result (UEC_CALL *get_streaming_level_count)(uec_world* world, uint32_t* out_count);
    ...
    uec_result (UEC_CALL *set_component_physics_velocity)(uec_scene_component* component, uec_vector3 velocity, uec_bool add_to_current); uec_result (UEC_CALL *apply_component_impulse)(uec_scene_component* component, uec_vector3 impulse, uec_bool velocity_change); uec_result (UEC_CALL *apply_component_force)(uec_scene_component* component, uec_vector3 force); uec_result (UEC_CALL *get_component_physics_angular_velocity)(uec_scene_component* component, uec_vector3* out_velocity); uec_result (UEC_CALL *set_component_physics_angular_velocity)(uec_scene_component* component, uec_vector3 velocity, uec_bool add_to_current); uec_result (UEC_CALL *apply_component_torque)(uec_scene_component* component, uec_vector3 torque, uec_bool acceleration_change); uec_result (UEC_CALL *apply_component_angular_impulse)(uec_scene_component* component, uec_vector3 impulse, uec_bool velocity_change); uec_result (UEC_CALL *get_actor_physics_angular_velocity)(uec_actor* actor, uec_vector3* out_velocity); uec_result (UEC_CALL *set_actor_physics_angular_velocity)(uec_actor* actor, uec_vector3 velocity, uec_bool add_to_current); uec_result (UEC_CALL *apply_actor_torque)(uec_actor* actor, uec_vector3 torque, uec_bool acceleration_change); uec_result (UEC_CALL *apply_actor_angular_impulse)(uec_actor* actor, uec_vector3 impulse, uec_bool velocity_change); uec_result (UEC_CALL *get_actor_property_soft_value)(uec_actor* actor, uec_string_view property_name, uec_text_output* out_value); uec_result (UEC_CALL *get_object_property_soft_value)(uec_object* object, uec_string_view property_name, uec_text_output* out_value); uec_result (UEC_CALL *set_actor_property_soft_value)(uec_actor* actor, uec_string_view property_name, uec_property_kind kind, uec_string_view path); uec_result (UEC_CALL *set_object_property_soft_value)(uec_object* object, uec_string_view property_name, uec_property_kind kind, uec_string_view path); uec_result (UEC_CALL *get_actor_property_map_key)(uec_actor* actor, uec_string_view property_name, uint32_t index, uec_property_value* out_key); uec_result (UEC_CALL *get_object_property_map_key)(uec_object* object, uec_string_view property_name, uint32_t index, uec_property_value* out_key); uec_result (UEC_CALL *invoke_actor_function_arguments)(uec_actor* actor, uec_string_view function_name, const uec_function_argument* arguments, uint32_t argument_count, uec_function_output* outputs, uint32_t output_capacity, uint32_t* out_count); uec_result (UEC_CALL *get_or_create_actor_event_bridge)(uec_actor* actor, uec_object** out_bridge); uec_result (UEC_CALL *destroy_actor_event_bridge)(uec_object* bridge); uec_result (UEC_CALL *bind_actor_event_bridge)(uec_object* bridge, uec_event_bridge_callback callback, void* user_data, uint64_t* out_subscription_id); uec_result (UEC_CALL *unbind_actor_event_bridge)(uec_context* context, uint64_t subscription_id); uec_result (UEC_CALL *emit_actor_event_bridge)(uec_object* bridge, int64_t event_id, int64_t integer_value, double real_value, uec_string_view text_value); uec_result (UEC_CALL *invoke_actor_function_latent)(uec_actor* actor, uec_string_view function_name, const uec_function_argument* arguments, uint32_t argument_count, uec_latent_function_callback callback, void* user_data, uint64_t* out_request_id); uec_result (UEC_CALL *cancel_actor_function_latent)(uec_context* context, uint64_t request_id);
    uec_result (UEC_CALL *save_versioned_application_data)(uec_context* context, uec_string_view slot_name, int32_t user_index, uint32_t schema_version, const uint8_t* data, size_t data_size, uec_bool* out_saved); uec_result (UEC_CALL *load_versioned_application_data)(uec_context* context, uec_string_view slot_name, int32_t user_index, uint32_t* out_schema_version, uint8_t* buffer, size_t buffer_capacity, size_t* out_required_size); uec_result (UEC_CALL *get_controller_enhanced_input_subsystem)(uec_actor* controller, uec_object** out_subsystem); uec_result (UEC_CALL *set_component_collision_channel_response)(uec_scene_component* component, uec_trace_channel channel, uec_collision_response response); uec_result (UEC_CALL *get_progress_bar_percent)(uec_object* progress_bar, double* out_percent); uec_result (UEC_CALL *set_progress_bar_percent)(uec_object* progress_bar, double percent); uec_result (UEC_CALL *get_widget_enabled)(uec_object* widget, uec_bool* out_enabled); uec_result (UEC_CALL *set_widget_enabled)(uec_object* widget, uec_bool enabled); uec_result (UEC_CALL *get_checkbox_state)(uec_object* checkbox, uec_checkbox_state* out_state); uec_result (UEC_CALL *set_checkbox_state)(uec_object* checkbox, uec_checkbox_state state); uec_result (UEC_CALL *get_widget_child)(uec_object* user_widget, uec_string_view child_name, uec_object** out_child); uec_result (UEC_CALL *set_component_simulating_physics)(uec_scene_component* component, uec_bool simulating); uec_result (UEC_CALL *get_component_simulating_physics)(uec_scene_component* component, uec_bool* out_simulating);
} uec_api;
