...
static const uec_api g_api = {
    ...
    .log = &StubLog,
    .release_context = &StubReleaseContext, .release_object = &StubReleaseObject,
    ...
    .get_text_block_text = &StubGetTextBlockText, .set_text_block_text = &StubSetTextBlockText,
    ...
    .trace_detailed = &StubTraceDetailed, .trace_detailed_filtered = &StubTraceDetailedFiltered, .line_trace_filtered = &StubLineTraceFiltered, .sweep_trace_filtered = &StubSweepTraceFiltered, .overlap_shape = &StubOverlapShape, .overlap_shape_filtered = &StubOverlapShapeFiltered,
    ...
    .set_progress_bar_percent = &StubSetProgressBarPercent, .get_widget_enabled = &StubGetWidgetEnabled, .set_widget_enabled = &StubSetWidgetEnabled, .get_checkbox_state = &StubGetCheckBoxState, .set_checkbox_state = &StubSetCheckBoxState, .get_widget_child = &StubGetWidgetChild, .set_component_simulating_physics = &StubSetComponentSimulatingPhysics, .get_component_simulating_physics = &StubGetComponentSimulatingPhysics
};
