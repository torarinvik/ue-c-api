...
static const uec_api g_api = {
    ...
    .trace_detailed = &StubTraceDetailed, .trace_detailed_filtered = &StubTraceDetailedFiltered, .line_trace_filtered = &StubLineTraceFiltered, .overlap_shape = &StubOverlapShape, .overlap_shape_filtered = &StubOverlapShapeFiltered,
